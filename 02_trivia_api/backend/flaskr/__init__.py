...
def create_app(test_config=None):
  ...
  def create_or_search_question():
    ...
    if search_term is None:
      return create_question(request, question, answer, difficulty, category)
    else:
  ...
  def search_questions(search_term):
    current_questions = Question.query.filter(Question.question.ilike('%'+search_term+'%')).all()
    formmated_current_questions = [question.format() for question in current_questions]
    return jsonify({
        'success' : True,
